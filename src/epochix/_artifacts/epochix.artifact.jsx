 ...
 *   • "pip install epochix" marketing banner after first parse
 *   • Optional LLM fallback via Claude API (set CLAUDE_API_KEY prop)
 *
 * Usage in an artifact:
 *   <EpochixArtifact />
 *   <EpochixArtifact panel="hero" />
 */
...
<title>epochix Training Report</title>
<style>
...
<p style="font-size:12px;color:#444;margin-top:32px">
  Generated by <a href="https://github.com/hexorax/epochix" style="color:#6366f1">epochix</a> &bull;
  <code>pip install epochix</code>
</p>
</body>
</html>`;
}
...
export default function EpochixArtifact({ panel = null, apiKey = null }) {
  ...
  const handleExport = useCallback(() => {
    ...
    try {
      ...
      a.href = url;
      a.download = `epochix-report-${run.runId}.html`;
      a.click();
      ...
      {!forcePanel && (
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <span style={{ fontSize: 17, fontWeight: 700, color: '#e2e8f0' }}>epochix</span>
          </div>
