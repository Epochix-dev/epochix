...
converts it into model-story events fed through the standard pipeline.

Usage::

    # CLI
    model-story import-wandb --entity myorg --project bert-finetune --run-id abc123

    # Python
    from model_story.integrations.wandb_import import import_wandb
...
def import_wandb(
    *,
    ...
    port:
        Port of the model-story server.
    open_browser:
